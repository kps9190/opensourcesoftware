...
import '../signup_login_page/login_option_page.dart';
...
class CustomerMyPageScreen extends StatefulWidget {
  const CustomerMyPageScreen({super.key});

  @override
  State<CustomerMyPageScreen> createState() => _CustomerMyPageScreenState();
}

class _CustomerMyPageScreenState extends State<CustomerMyPageScreen>
          ...
          if (!isLoggedIn)
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const LoginOptionPage()),
                );
              },
